...
class AdminHome(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.create_item = tk.Button(self, text="Create Item", command=lambda: self.controller.show_frame('admincreateitem'))
        self.create_item.grid(row=1, column=0)
        
        self.create_drone = tk.Button(self, text="Create Drone", command=lambda: self.controller.show_frame('admincreatedrone'))
